...
import lampetia.model.{Models, Property}
import lampetia.sql.ast.{Operator, Operand, Dsl}
...
package object h2 extends Dsl with JdbcCodec with ConnectionSourceFactories with Models {
